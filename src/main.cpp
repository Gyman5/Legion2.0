...
const string strMessageLegion = "Legion Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nFees, uint256 prevHash)

{
    int64_t nSubsidy = COIN_POS_REWARD;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfStake())
    {
        ...
        int64_t nCalculatedStakeReward = GetProofOfStakeReward(nFees, prevHash);
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Legion", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //block.GetHash() == 000002dcd8bd46059b3dc3a654422954bec355d561a6937eccbeb4e116911aa2
        //block.hashMerkleRoot == af3c37310291ee03580f3f05059034a60fa3f68abe013515d473ee0aa6e6c953
        //block.nTime = 1546797990 
        //block.nNonce = 1821753


        const char* pszTimestamp = "We are Legion, we are many Jan 6 2018";
        CTransaction txNew;
        txNew.nTime = 1546797990;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = !fTestNet ? 1821753 : 0;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0xaf3c37310291ee03580f3f05059034a60fa3f68abe013515d473ee0aa6e6c953"));
